...
interface DocComercialesDataTableProps {
  table: Table<DocumentoComercialView>
  router: ReturnType<typeof useRouter>
}

/**
 * DocComercialesDataTable - Presentation component for documentos comerciales table
 *
 ...
 * ```
 */
export function DocComercialesDataTable({ table, router }: DocComercialesDataTableProps) {
  return (
          ...
          table.getRowModel().rows.map((row) => (
            <TableRow
              ...
              onClick={(e) => {
                ...
                router.push(`/admin/procesos/documentos-comerciales/${(row.original as { id: string }).id}`)
              }}
            >
