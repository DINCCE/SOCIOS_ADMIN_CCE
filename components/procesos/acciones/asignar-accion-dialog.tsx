...
interface AsignarAccionDialogProps {
    open?: boolean
    onOpenChange?: (open: boolean) => void
}

export function AsignarAccionDialog({ open: controlledOpen, onOpenChange: controlledOnOpenChange }: AsignarAccionDialogProps) {
