                  ...
                  return (
                    <TableHead
                      ...
                      className={cn(
                        ...
                        header.column.id === "nombre_completo" && "min-w-[250px] sticky left-[48px] z-20 bg-slate-50 border-r border-border/80 shadow-[2px_0_8px_-2px_rgba(0,0,0,0.05)]",
                  ...
                  {row.getVisibleCells().map((cell) => (
                    <TableCell
                      ...
                      className={cn(
                        ...
                        cell.column.id === "nombre_completo" && "sticky left-[48px] z-10 bg-background group-hover:bg-muted/50 group-data-[state=selected]:bg-muted border-r border-border/80 shadow-[2px_0_8px_-2px_rgba(0,0,0,0.05)]"
                      )}
                    >
                      {flexRender(
