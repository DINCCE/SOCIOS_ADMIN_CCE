-- ============================================================================
-- Migration: Enhance obtener_relaciones_bp() to return complete data
-- Description: Returns full relationship records + enriched persona data
--              including atributos, individual name fields, photos, contact
-- Author: Sistema
-- Date: 2026-01-04
-- ============================================================================
...
COMMENT ON FUNCTION public.obtener_relaciones_bp IS
  'Obtiene todas las relaciones de un Business Partner con datos completos de personas (origen y destino). Incluye atributos, nombres individuales, fotos, y contactos. Útil para interfaces de usuario que necesitan mostrar información detallada de familiares.';
